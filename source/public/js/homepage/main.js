...
saveIDCard.addEventListener('click',()=>{
    const email = document.querySelector('#emailForUpdateIDCard').value;
        ...
        fetch("http://localhost:8080/API/updateIDCard",
            {
                ...
                body: JSON.stringify({email:email,frontIdCard,backIdCard})
            }
        )
        .then(data=>{
...
openChangePassFormBtn.addEventListener('click',()=>{
    ...
    changePassForm.innerHTML=`
        <div style="display:flex;justify-content: center;flex-direction: column;text-align: center;background: #f2f2fc;padding: 10px;border-radius: 5px;" >
            ...
            <input style="padding: 8px;margin-top: 10px; border: 1px solid black;border-radius: 8px" type="password" placeholder="Enter your current password" class="inputChangePass" required>
            <input style="padding: 8px;margin-top: 10px; border: 1px solid black;border-radius: 8px" type="password" placeholder="Enter your new password" class="inputChangePass" required>
            <input style="padding: 8px;margin-top: 10px; border: 1px solid black;border-radius: 8px" type="password" placeholder="Re-Enter your current password" class="inputChangePass" required>
